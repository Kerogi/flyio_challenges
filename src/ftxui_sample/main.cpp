...
// configuration step. It creates a namespace called `flyio_challenges`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", flyio_challenges::cmake::project_name, flyio_challenges::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", flyio_challenges::cmake::project_version);
      return EXIT_SUCCESS;
    }
